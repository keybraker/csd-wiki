...
#define PROGRAM_BEGIN_PRINT \
    ;                       \
    cout << "JSONprojectHY352 starting execution" << endl
#define PROGRAM_END_PRINT \
    ;                     \
    cout << "JSONprojectHY352 execution has ended" << endl
...
public:
    ...
    myType &operator*=(string namer)
    {
        printerino(namer, this)
    ...
    myType &operator[](int what)
    {
        printerino(what, this)
        ...
        else
        {
            ...
            {
                cout << "DID NOT INSERT NUMBER > SIZE" << endl;
            }
        }

        return *this;
    }
    myType &operator[](const char *what)
    {
        printerino(what, this)
                ...
                if (this->headOFdata[i].headOFdata[j].hidden == true)
                {
                    ...
                    if (value.which == 1)
                    {
                        if (value.getNAME() != "")
                        {
                            ...
                            this->headOFdata[i].headOFdata[j].headOFdata[this->headOFdata[i].headOFdata[j].headOFdata.size() - 1].setSTRING(value.getSTRING());
                            this->headOFdata[i].headOFdata[j].headOFdata[this->headOFdata[i].headOFdata[j].headOFdata.size() - 1].setWHICH(value.getWHICH());
                    ...
                    else if (value.which == 2)
                    {
                        if (value.getNAME() != "")
                        {
                            ...
                            this->headOFdata[i].headOFdata[j].headOFdata.push_back(value);
                            this->headOFdata[i].headOFdata[j].headOFdata[this->headOFdata[i].headOFdata[j].headOFdata.size() - 1].setNAME(value.getNAME());
                            this->headOFdata[i].headOFdata[j].headOFdata[this->headOFdata[i].headOFdata[j].headOFdata.size() - 1].setINTEGER(value.getINTEGER());
                            this->headOFdata[i].headOFdata[j].headOFdata[this->headOFdata[i].headOFdata[j].headOFdata.size() - 1].setWHICH(value.getWHICH());
                            this->headOFdata[i].headOFdata[j].setWHICH(6);
                        }
                        else
                    ...
                    else if (value.which == 4)
                    {
                        if (value.getNAME() != "")
                        {
                            ...
                            this->headOFdata[i].headOFdata[j].headOFdata[this->headOFdata[i].headOFdata[j].headOFdata.size() - 1].setNAME(value.getNAME());
                            this->headOFdata[i].headOFdata[j].headOFdata[this->headOFdata[i].headOFdata[j].headOFdata.size() - 1].setINTEGER(value.getINTEGER());
                            this->headOFdata[i].headOFdata[j].headOFdata[this->headOFdata[i].headOFdata[j].headOFdata.size() - 1].setBOOLEAN(value.getBOOLEAN());
                            this->headOFdata[i].headOFdata[j].setWHICH(6);
                        }
                        else
                        {
    ...
    myType operator/=(myType &value)
    {
        printerino(value, this) // ERASE

            myType tmp;

        if (value.deleteMe == true)
        { // Whole Erase
            value.clear();
        }
        else
    ...
    myType &operator+(myType value)
    {
        printerino(value, this)
            ...
            if (this->getNAME() != "" && this->getSTRING() != "")
        { // objects of one variable

            myType created;

            if (this->getWHICH() == 1 && this->getSTRING() != "")
            { // strings
            ...
            else if (this->getWHICH() == 2 && this->getINTEGER() != MAX_INT_JSON)
            { // integer
                created.addHEADOFDATA(*this);
                this->clear();
                this->addHEADOFDATA(created.getHEAD()[0]);
            ...
            else if (this->getWHICH() == 3 && this->getINTEGER() != MAX_INT_JSON)
            { // integer
                created.addHEADOFDATA(*this);
                this->clear();
                this->addHEADOFDATA(created.getHEAD()[0]);
            ...
            else if (this->getWHICH() == 5 && !this->getARRAY().empty())
            { // array
                created.addHEADOFDATA(*this);
                this->clear();
                this->addHEADOFDATA(created.getHEAD()[0]);
            ...
            else if ((this->getWHICH() == 6 || this->getWHICH() == 7) && !this->getHEAD().empty())
            { // object array
                created.addHEADOFDATA(*this);
                this->clear();
                this->addHEADOFDATA(created.getHEAD()[0]);
        ...
        else if (this->getWHICH() == 2 && value.getWHICH() == 2)
        { // numbers
            this->setINTEGER(this->getINTEGER() + value.getINTEGER());
        }
        else if (this->getWHICH() == 4 && value.getWHICH() == 4)
        { // boolean
            this->setBOOLEAN(this->getBOOLEAN() + value.getBOOLEAN());
        }
        else if (this->getWHICH() == 5 && value.getWHICH() == 5)
        { // arrays
    ...
    myType &operator-(myType value)
    {
        printerino(value, this)
            ...
            if ((this->getWHICH() == 2 || this->getWHICH() == 3) &&
                (value.getWHICH() == 2 || value.getWHICH() == 3))
        { // numbers
            this->setINTEGER(this->getINTEGER() - value.getINTEGER());
        }
    ...
    myType operator&&(myType value)
    {
        printerino(value, this)
            ...
            if (this->getWHICH() == 4 && value.getWHICH() == 4)
        { // boolean
    ...
    const bool &operator==(myType value)
    {
        printerino(value, this)
        ...
        else if ((this->getWHICH() == 2 || this->getWHICH() == 3) && (value.getWHICH() == 2 || value.getWHICH() == 3))
        { // numbers
