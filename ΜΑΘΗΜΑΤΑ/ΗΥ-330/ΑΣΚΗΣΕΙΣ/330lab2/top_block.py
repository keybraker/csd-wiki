...
# Title: Top Block
# Generated: Fri Nov 25 17:46:20 2016
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.samples_per_symbol = samples_per_symbol = 3
        self.taps = taps = firdes.root_raised_cosine(32, 32, 1.0, 0.5, 32 * 11 * samples_per_symbol)
        self.samp_rate = samp_rate = 1e6
        self.noise = noise = 0.0
        self.mod_order = mod_order = 4
        self.constellation_3 = constellation_3 = [-1+1j, +1+1j, -1-1j, +1-1j, -2+2j, +2+2j, -2-2j, +2-2j, -1+2j, -1-2j, +1+2j, +1-2j, -2+1j, -2-1j, +2+1j,+2-1j,
        +3 -1j, +4-1j, +3-2j, +4-2j, +1-3j, +1-4j, +2-3j, +2-4j, +3-3j, +3-4j, +4-3j, +4-4j,
        +3 +1j, +4+1j, +3+2j, +4+2j, +1+3j, +1+4j, +2+3j, +2+4j, +3+3j, +3+4j, +4+3j, +4+4j,
        -3 -1j, -4-1j, -3-2j, -4-2j, -1-3j, -1-4j, -2-3j, -2-4j, -3-3j, -3-4j, -4-3j, -4-4j,
        -3 +1j, -4+1j, -3+2j, -4+2j, -1+3j, -1+4j, -2+3j, -2+4j, -3+3j, -3+4j, -4+3j, -4+4j,
        ]
        self.constellation_2 = constellation_2 = [-1+1j, +1+1j, -1-1j, +1-1j, -2+2j, +2+2j, -2-2j, +2-2j, -1+2j, -1-2j, +1+2j, +1-2j, -2+1j, -2-1j, +2+1j,+2-1j]
        self.constellation_1 = constellation_1 = [+1+0j,-1+0j,+0-1j,+0+1j,+0.70710678118+0.70710678118j,- 0.70710678118+0.70710678118j,- 0.70710678118-0.70710678118j,+ 0.70710678118-0.70710678118j]
        self.constellation_0 = constellation_0 = [-1-1j, +1+1j, +1-1j, -1+1j]
    ...
    def set_samples_per_symbol(self, samples_per_symbol):
        ...
        self.set_taps(firdes.root_raised_cosine(32, 32, 1.0, 0.5, 32 * 11 * self.samples_per_symbol))
    ...
    def set_taps(self, taps):
        self.taps = taps
        self.pfb_arb_resampler_xxx_0.set_taps((self.taps))
    ...
    def get_constellation_3(self):
        return self.constellation_3

    def set_constellation_3(self, constellation_3):
        self.constellation_3 = constellation_3
