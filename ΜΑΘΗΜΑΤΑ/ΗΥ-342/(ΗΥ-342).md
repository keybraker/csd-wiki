...
1. **Runnable**: *Εκτελείται αυτή τη στιγμή ή μπορεί να εκτελεστεί σε οποιοδήποτε ελεύθερο CPU core*
1. **Blocked**: *Περιμένει για I/O, lock, ή κάποιο άλλο synchronization operation*
