...
std::string functionname (){                    // there are four function for the four words that have to be read
...
int main()
{
    ...
    std::cout << "Welcome to the Story Maker." << std::endl << std::endl ;
    ...
    std::cout  << std::endl  << std::endl << "Here's your story:" << std::endl ;
