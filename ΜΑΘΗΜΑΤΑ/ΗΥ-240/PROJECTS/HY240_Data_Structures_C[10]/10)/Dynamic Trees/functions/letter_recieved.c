 ...
 ********************************************/
struct child *findLargerestSmaller(struct child *Age_categories, int cid)
...
int checkForChild(struct child *Age_categories, int cid, int pid1, int pid2, int pid3)
{
    ...
    if (Age_categories->cid == cid)
    { // printf(" ΤΟ ΠΑΙΔΙ ΥΠΑΡΧΕΙ ΑΡΑ ΤΟΥ ΒΑΖΩ ΤΑ ΝΕΑ ΔΩΡΑ\n");
